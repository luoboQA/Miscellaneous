 ...
 * 
 * 与 MyMap 的区别：
 * - MyMap：红黑树，O(log n)，键有序
 * - MyUnorderedMap：哈希表，O(1) 平均，键无序
 * 
 ...
 */
template<typename Key, typename Value>
void swap(MyUnorderedMap<Key, Value>& a, MyUnorderedMap<Key, Value>& b) {
    a.swap(b);
}
