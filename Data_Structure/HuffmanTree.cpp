...
权值:    -    65   66   67   68   69   131  135  200  335
父结点:  -    6    6    7    7    8    8    9    9    0
左孩子:  -    0    0    0    0    0    1    3    5    7
右孩子:  -    0    0    0    0    0    2    4    6    8

6	[F]	第一个内部结点（合并 A 和 B，65+66=131）
7	[G]	第二个内部结点（合并 C 和 D，67+68=135）
8	[H]	第三个内部结点（合并 E 和 F，69+131=200）
9	[I]	第四个内部结点（根，合并 G 和 H，135+200=335）
